---
title: "Cairn v0.5.0 - The Smart Memory Plan"
type: plan
status: superseded
updated: 2026-07-01
version: 0.5.0
...
## S1. The Six Dimensions of Smart Memory
...
**Credit:** Cross-Session Protocol pattern adopted from **lean-ctx** (`docs/reference/03-memory-and-knowledge.md` S1).
...
**Credit:** RRF formula and hybrid search fusion adopted from **lean-ctx** (`LEANCTX_FEATURE_CATALOG.md` SHybrid Search Fusion).
...
## S3. New Crate / API / CLI / MCP Surface
...
> [x]... **Status (v0.5.0):** Both sprints shipped. `cairn-bench` crate holds the
...
> [x]... **Status (v0.5.0):** Sprints 18, 19, 20, 22 shipped. Sprints 21 (browser
...
- [Vision](../reference/vision.md) - original v0.4.0 vision
- [Roadmap](../planning/roadmap.md) - what is done, what is next
- [Architecture](../reference/architecture.md) - current crate graph and API surface
- [Web](../guides/web-auth.md) - v0.4.0 dashboard surface (will be updated for v0.5.0)
- [Benchmarks](../testing/benchmarks.md) - measured numbers + targets
- [Decisions](../reference/decisions.md) - ADRs for the v0.5.0 decisions will be added here (see planned ADR-010 through ADR-016 below)

### S9.1 Planned v0.5.0 ADRs
