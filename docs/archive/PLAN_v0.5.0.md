...
## ÂS1. The Six Dimensions of Smart Memory
...
**Credit:** Cross-Session Protocol pattern adopted from **lean-ctx** (`docs/reference/03-memory-and-knowledge.md` ÂS1).
...
**Credit:** RRF formula and hybrid search fusion adopted from **lean-ctx** (`LEANCTX_FEATURE_CATALOG.md` ÂSHybrid Search Fusion).
...
## ÂS3. New Crate / API / CLI / MCP Surface
