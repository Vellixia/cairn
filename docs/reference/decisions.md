...
1. Canonical extension is `.cairnpkg` (not `.ctxpkg`); `.ctxpkg` is accepted as an import
   alias for interop per plan S10.
...
`docs/testing/benchmarks.md`. Instructions for running the upstream LongMemEval against
...
- Users on Cursor/VSCode/Windsurf lose the one-command setup. They
  ...
  agent's MCP panel. Documented in `docs/guides/upgrading.md` for v0.5.0
  -> v0.6.0.
...
- [Web](../guides/web-auth.md) - admin/CLI auth split surface
- [Upgrading](../guides/upgrading.md) - 0.5.0 -> 0.6.0 migration
- [Plan v0.6.0](../planning/plans/v0.6.0.md) - v0.6.0 cleanup sprint
