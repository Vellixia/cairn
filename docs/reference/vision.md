---
title: "Cairn - The Open-Source Context & Reliability Layer for AI Agents"
type: vision
status: living
updated: 2026-07-01
---
...
- [Roadmap](../planning/roadmap.md) - what's done, what's in progress, what's next
- [Benchmarks](../testing/benchmarks.md) - methodology + measured numbers + targets
